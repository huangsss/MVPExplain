package com.huangasys.veke.app_github_mvp.adapter;
...
import com.huangasys.veke.app_github_mvp.R;
...
public class RepositoryAdapter extends RecyclerView.Adapter<RepositoryAdapter.RepositoryViewHolder>{
    ...
    private List<UserRepo> repositoryList ;

    public RepositoryAdapter(Context context, List<UserRepo> repositoryList){
    ...
    public void onBindViewHolder(RepositoryViewHolder holder, int position) {
        UserRepo repository = repositoryList.get(position);
